var behancekey = "rxDRsVFiOxXog4ywUmUOTargncJXOsYN";
...
function traducir() {
	...
	var f = ['UI/UX','Information Architecture','Branding','Creative Direction','Graphic Design','Web Design','Web Development','Digital Photography','Photography','Programming','Industrial Design','Advertising','Exhibition Design','Furniture Design','Retouching'];
	var r = ['Interfaz y experiencia de usuario','Arquitectura de la información','Marca','Dirección creativa','Diseño gráfico','Diseño web','Desarrollo web','Fotografía digital','Fotografía','Programación','Diseño Industrial','Publicidad','Diseño de Exposición','Diseño de Mobiliario','Retoque'];
...
$(document).ready(function() {
	...
	// Get projects
	behanceAPI.getProjects("diorvi", function(projectlist) {
...
http://jsonviewer.stack.hu/#http://www.behance.net//v2/users/lorspi/projects?api_key=RxPJ53OdMDUM424T6pEmJl2wYO54STtV
